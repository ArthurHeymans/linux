...
unsafe extern "C" {
    ...
    static __download_trace_pc: u8;
}

#[inline(always)]
fn download_image_size() -> *mut u32 {
    (&raw const __download_control_base).cast_mut().cast()
}

#[inline(always)]
fn download_trace_pc() -> *mut u32 {
    (&raw const __download_trace_pc).cast_mut().cast()
}
