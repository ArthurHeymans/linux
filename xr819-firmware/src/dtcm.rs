...
mod tests {
    ...
    fn register_write_lists_after_iq_gain_indices_are_exact() { let image = DTCM_STATE_BASE; let cal = image + core::mem::offset_of!(InitializedVendorImage, phy_cal_substate_register_write_list); let dbg = image + core::mem::offset_of!(InitializedVendorImage, dbg_expand_register_write_list); assert_eq!(core::mem::size_of::<PhyCalSubstateRegisterWriteList>(), 0x48); assert_eq!(core::mem::align_of::<PhyCalSubstateRegisterWriteList>(), 4); assert_eq!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, writes), 0); assert_eq!(core::mem::size_of::<[RegisterWrite; 8]>(), 0x40); assert_eq!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, terminator_address), 0x40); assert_eq!(cal, 0x0400_0e48); assert_eq!(cal + core::mem::size_of::<PhyCalSubstateRegisterWriteList>(), 0x0400_0e90); assert_eq!(core::mem::size_of::<DbgExpandRegisterWriteList>(), 0x30); assert_eq!(core::mem::align_of::<DbgExpandRegisterWriteList>(), 4); assert_eq!(core::mem::offset_of!(DbgExpandRegisterWriteList, writes), 0); assert_eq!(core::mem::size_of::<[RegisterWrite; 5]>(), 0x28); assert_eq!(core::mem::offset_of!(DbgExpandRegisterWriteList, terminator_address), 0x28); assert_eq!(dbg, 0x0400_0e90); assert_eq!(dbg + core::mem::size_of::<DbgExpandRegisterWriteList>(), 0x0400_0ec0); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, pre_rf_scale_tables), 0x0400_0ec0); assert_eq!(core::mem::size_of::<OpaqueBytes<0xc8>>(), 0xc8); assert_eq!(core::mem::size_of::<RfScaleHalfwordTable>(), 0x80); assert_eq!(core::mem::align_of::<RfScaleHalfwordTable>(), 2); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a), 0x0400_0f88); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1008); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b), 0x0400_1008); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1088); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rate_pointer_targets), 0x0400_1088); assert_eq!(core::mem::size_of::<OpaqueBytes<0x20>>(), 0x20); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table), 0x0400_10a8); assert_eq!(core::mem::size_of::<TxGainRssiHalfwordTable>(), 0x2c); assert_eq!(core::mem::align_of::<TxGainRssiHalfwordTable>(), 2); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table) + core::mem::size_of::<TxGainRssiHalfwordTable>(), 0x0400_10d4); assert_eq!(DURATION_QUANTUM_POINTERS.get(), 0x0400_10d4); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); assert_eq!(core::mem::align_of::<InitializedVendorImage>(), 4); assert_eq!(core::mem::size_of::<DtcmLayout>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<DtcmLayout>(), 4); assert_eq!(core::mem::size_of::<SharedDtcmState>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<SharedDtcmState>(), 4); } #[test]
