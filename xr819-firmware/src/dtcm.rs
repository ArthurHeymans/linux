...
const _: () = {
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, mac_slot_timing_patch_list) == 0x0000); assert_type_layout!(MacSlotTimingPatchEntry, 0x08, 4); assert!(core::mem::offset_of!(MacSlotTimingPatchEntry, pointer) == 0); assert!(core::mem::offset_of!(MacSlotTimingPatchEntry, patch_word) == 0x04); assert_type_layout!(MacSlotTimingPatchList, 0x58, 4); assert!(core::mem::offset_of!(MacSlotTimingPatchList, entries) == 0); assert!(core::mem::size_of::<[MacSlotTimingPatchEntry; 11]>() == 0x58); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, mac_slot_timing_patch_list) + core::mem::size_of::<MacSlotTimingPatchList>() == 0x0400_0058); assert!(core::mem::offset_of!(InitializedVendorImage, pac_duration_quanta) == 0x0058); assert_type_layout!(PacDurationQuanta, 0x20, 4); assert!(core::mem::offset_of!(PacDurationQuanta, quanta) == 0); assert!(core::mem::size_of::<[SharedU32; 8]>() == 0x20); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, pac_duration_quanta) + core::mem::size_of::<PacDurationQuanta>() == 0x0400_0078); assert!(core::mem::offset_of!(InitializedVendorImage, prefix_suffix) == 0x0078); assert!(core::mem::size_of::<OpaqueBytes<0xc0>>() == 0xc0); assert!(core::mem::offset_of!(InitializedVendorImage, tx_duration_timing) == 0x0138); assert!(core::mem::offset_of!(InitializedVendorImage, pas_rate_static_tables) == 0x014c); assert_type_layout!(PasRateStaticTables, 0x48, 4); assert!(core::mem::offset_of!(PasRateStaticTables, mcs_fallback_rates) == 0x00); assert!(core::mem::offset_of!(PasRateStaticTables, pas_fallback_suffix) == 0x08); assert!(core::mem::size_of::<OpaqueBytes<0x8>>() == 0x8); assert!(core::mem::offset_of!(PasRateStaticTables, ofdm_airtime_durations) == 0x10); assert!(core::mem::size_of::<[SharedU16; 16]>() == 0x20); assert!(core::mem::offset_of!(PasRateStaticTables, rate_group_records) == 0x30); assert!(core::mem::size_of::<[SharedU32; 6]>() == 0x18); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, pas_rate_static_tables) + core::mem::size_of::<PasRateStaticTables>() == 0x0400_0194);
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, completion_callback_prefix) == 0x0228); assert_type_layout!(CompletionCallbackPrefix, 0x38, 4); assert!(core::mem::offset_of!(CompletionCallbackPrefix, completion_prefix_suffix) == 0x00); assert!(core::mem::size_of::<OpaqueBytes<0x30>>() == 0x30); assert!(core::mem::offset_of!(CompletionCallbackPrefix, p2p_action_offsets) == 0x30); assert!(core::mem::size_of::<[SharedU8; 8]>() == 0x08); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, completion_callback_prefix) + core::mem::size_of::<CompletionCallbackPrefix>() == 0x0400_0260);
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, ring_cursor_map_tables) == 0x0288); assert_type_layout!(RingCursorMapTables, 0x50, 4); assert!(core::mem::offset_of!(RingCursorMapTables, beacon_mask_words) == 0x00); assert!(core::mem::size_of::<[SharedU32; 8]>() == 0x20); assert!(core::mem::offset_of!(RingCursorMapTables, mib_defaults_template) == 0x20); assert!(core::mem::size_of::<OpaqueBytes<0x30>>() == 0x30); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, ring_cursor_map_tables) + core::mem::size_of::<RingCursorMapTables>() == 0x0400_02d8); assert!(core::mem::offset_of!(InitializedVendorImage, queue_pipe_mappings) == 0x02d8);
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, debug_console_strings) == 0x07a4); assert_type_layout!(DebugConsoleStrings, 0x60, 4); assert!(core::mem::offset_of!(DebugConsoleStrings, console_help_text) == 0x00); assert!(core::mem::size_of::<OpaqueBytes<0x50>>() == 0x50); assert!(core::mem::offset_of!(DebugConsoleStrings, hex_digits) == 0x50); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, debug_console_strings) + core::mem::size_of::<DebugConsoleStrings>() == 0x0400_0804); assert!(core::mem::offset_of!(InitializedVendorImage, aes_transfer_classes) == 0x0804);
    assert!(core::mem::offset_of!(InitializedVendorImage, vendor_encoded_help_text) == 0x0830); assert_type_layout!(VendorEncodedHelpText, 0x1ae, 2); assert!(core::mem::offset_of!(VendorEncodedHelpText, encoded_help_text) == 0); assert!(core::mem::size_of::<OpaqueBytes<0x1ae>>() == 0x1ae);
    assert!(core::mem::offset_of!(InitializedVendorImage, vendor_debug_encoded_banner) == 0x09de); assert_type_layout!(VendorDebugEncodedBanner, 0x14a, 2); assert!(core::mem::offset_of!(VendorDebugEncodedBanner, encoded_banner) == 0); assert!(core::mem::size_of::<OpaqueBytes<0x14a>>() == 0x14a); assert!(core::mem::offset_of!(InitializedVendorImage, exception_reason_names) == 0x0b28); assert_type_layout!(ExceptionReasonNames, 0x14, 4); assert!(core::mem::offset_of!(ExceptionReasonNames, names) == 0); assert!(core::mem::size_of::<[SharedU32; 5]>() == 0x14); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, exception_reason_names) == 0x0400_0b28); assert!(core::mem::offset_of!(InitializedVendorImage, hw_timer_debug_tables) == 0x0b3c); assert_type_layout!(HwTimerDebugTables, 0x24, 4); assert!(core::mem::offset_of!(HwTimerDebugTables, divisor_table) == 0x00); assert!(core::mem::size_of::<OpaqueBytes<0x1c>>() == 0x1c); assert!(core::mem::offset_of!(HwTimerDebugTables, channel_config_words) == 0x1c); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, hw_timer_debug_tables) + core::mem::size_of::<HwTimerDebugTables>() == 0x0400_0b60);
    assert!(core::mem::offset_of!(InitializedVendorImage, phy_gain_register_write_lists) == 0x0b60);
    assert!(core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_0) == 0x0c10); assert!(core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_1) == 0x0c20); assert!(core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_2) == 0x0c48); assert!(core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_3) == 0x0c60); assert_type_layout!(PhyInitRegisterWriteList3, 0x40, 4); assert!(core::mem::offset_of!(PhyInitRegisterWriteList3, writes) == 0); assert!(core::mem::size_of::<[RegisterWrite; 7]>() == 0x38); assert!(core::mem::offset_of!(PhyInitRegisterWriteList3, terminator_address) == 0x38); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_3) + core::mem::size_of::<PhyInitRegisterWriteList3>() == 0x0400_0ca0); assert!(core::mem::offset_of!(InitializedVendorImage, initialized_phy_gain_source_records) == 0x0ca0); assert!(core::mem::size_of::<[InitializedPhyGainSourceRecord; 44]>() == 0x108); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, initialized_phy_gain_source_records) + core::mem::size_of::<[InitializedPhyGainSourceRecord; 44]>() == 0x0400_0da8); assert!(core::mem::offset_of!(InitializedVendorImage, tlv_dispatch_handler_table) == 0x0da8); assert_type_layout!(TlvDispatchHandlerTable, 0x28, 4); assert!(core::mem::offset_of!(TlvDispatchHandlerTable, entries) == 0); assert!(core::mem::size_of::<[TlvDispatchHandlerEntry; 4]>() == 0x20); assert!(core::mem::offset_of!(TlvDispatchHandlerTable, terminator_key) == 0x20); assert!(core::mem::offset_of!(TlvDispatchHandlerTable, terminator_handler) == 0x24); assert_type_layout!(RfModeHalfwordTable, 0x48, 2); assert!(core::mem::offset_of!(RfModeHalfwordTable, entries) == 0); assert!(core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) == 0x0dd0); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) == 0x0400_0dd0); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) + core::mem::size_of::<RfModeHalfwordTable>() == 0x0400_0e18); assert!(RF_MODE_HALFWORD_TABLE.get() + 12 * core::mem::size_of::<SharedU16>() == 0x0400_0de8); assert!(core::mem::offset_of!(InitializedVendorImage, initialized_iq_calibration_gain_indices) == 0x0e18); assert!(core::mem::offset_of!(InitializedVendorImage, phy_cal_substate_register_write_list) == 0x0e48); assert_type_layout!(PhyCalSubstateRegisterWriteList, 0x48, 4); assert!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, writes) == 0); assert!(core::mem::size_of::<[RegisterWrite; 8]>() == 0x40); assert!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, terminator_address) == 0x40); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, phy_cal_substate_register_write_list) + core::mem::size_of::<PhyCalSubstateRegisterWriteList>() == 0x0400_0e90); assert!(core::mem::offset_of!(InitializedVendorImage, dbg_expand_register_write_list) == 0x0e90); assert_type_layout!(DbgExpandRegisterWriteList, 0x30, 4); assert!(core::mem::offset_of!(DbgExpandRegisterWriteList, writes) == 0); assert!(core::mem::size_of::<[RegisterWrite; 5]>() == 0x28); assert!(core::mem::offset_of!(DbgExpandRegisterWriteList, terminator_address) == 0x28); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, dbg_expand_register_write_list) + core::mem::size_of::<DbgExpandRegisterWriteList>() == 0x0400_0ec0); assert!(core::mem::offset_of!(InitializedVendorImage, pre_rf_scale_tables) == 0x0ec0); assert!(core::mem::size_of::<OpaqueBytes<0xc8>>() == 0xc8); assert_type_layout!(RfScaleHalfwordTable, 0x80, 2); assert!(core::mem::offset_of!(RfScaleHalfwordTable, entries) == 0); assert!(core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a) == 0x0f88); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a) + core::mem::size_of::<RfScaleHalfwordTable>() == 0x0400_1008); assert!(core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b) == 0x1008); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b) + core::mem::size_of::<RfScaleHalfwordTable>() == 0x0400_1088); assert!(core::mem::offset_of!(InitializedVendorImage, rate_pointer_targets) == 0x1088); assert!(core::mem::size_of::<OpaqueBytes<0x20>>() == 0x20); assert!(core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table) == 0x10a8); assert_type_layout!(TxGainRssiHalfwordTable, 0x2c, 2); assert!(core::mem::offset_of!(TxGainRssiHalfwordTable, entries) == 0); assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table) + core::mem::size_of::<TxGainRssiHalfwordTable>() == 0x0400_10d4); assert!(0x14a + 0x14 + 0x24 + 0x0b0 + 0x50 + (0x40 + 0x108 + 0x28 + 0x48 + 0x30 + (0x48 + 0x30 + (0xc8 + 0x80 + 0x80 + 0x4c))) == 0x6f6);
    assert!(core::mem::offset_of!(InitializedVendorImage, duration_quantum_pointers) == 0x10d4); assert!(core::mem::offset_of!(InitializedVendorImage, ps_wake_guard_words) == 0x10e4); assert_type_layout!(PsWakeGuardWords, 0x14, 4); assert!(core::mem::offset_of!(PsWakeGuardWords, word_10e4) == 0); assert!(core::mem::size_of::<OpaqueBytes<0x04>>() == 0x04); assert!(core::mem::offset_of!(PsWakeGuardWords, word_10ec) == 0x08); assert!(core::mem::offset_of!(PsWakeGuardWords, word_10f0) == 0x0c); assert!(core::mem::offset_of!(PsWakeGuardWords, opaque_10) == 0x10); assert!(core::mem::offset_of!(InitializedVendorImage, measurement_workspace) == 0x10f8); assert!(core::mem::offset_of!(InitializedVendorImage, tx_aggregate_expiration_delta) == 0x1160); assert!(core::mem::offset_of!(InitializedVendorImage, debug_command_descriptors) == 0x1164);
...
mod tests {
    ...
    fn register_write_lists_after_iq_gain_indices_are_exact() { let image = DTCM_STATE_BASE; let cal = image + core::mem::offset_of!(InitializedVendorImage, phy_cal_substate_register_write_list); let dbg = image + core::mem::offset_of!(InitializedVendorImage, dbg_expand_register_write_list); assert_eq!(core::mem::size_of::<PhyCalSubstateRegisterWriteList>(), 0x48); assert_eq!(core::mem::align_of::<PhyCalSubstateRegisterWriteList>(), 4); assert_eq!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, writes), 0); assert_eq!(core::mem::size_of::<[RegisterWrite; 8]>(), 0x40); assert_eq!(core::mem::offset_of!(PhyCalSubstateRegisterWriteList, terminator_address), 0x40); assert_eq!(cal, 0x0400_0e48); assert_eq!(cal + core::mem::size_of::<PhyCalSubstateRegisterWriteList>(), 0x0400_0e90); assert_eq!(core::mem::size_of::<DbgExpandRegisterWriteList>(), 0x30); assert_eq!(core::mem::align_of::<DbgExpandRegisterWriteList>(), 4); assert_eq!(core::mem::offset_of!(DbgExpandRegisterWriteList, writes), 0); assert_eq!(core::mem::size_of::<[RegisterWrite; 5]>(), 0x28); assert_eq!(core::mem::offset_of!(DbgExpandRegisterWriteList, terminator_address), 0x28); assert_eq!(dbg, 0x0400_0e90); assert_eq!(dbg + core::mem::size_of::<DbgExpandRegisterWriteList>(), 0x0400_0ec0); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, pre_rf_scale_tables), 0x0400_0ec0); assert_eq!(core::mem::size_of::<OpaqueBytes<0xc8>>(), 0xc8); assert_eq!(core::mem::size_of::<RfScaleHalfwordTable>(), 0x80); assert_eq!(core::mem::align_of::<RfScaleHalfwordTable>(), 2); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a), 0x0400_0f88); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_a) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1008); assert_eq!(RF_SCALE_TABLE_A_MODE0_TARGET.get(), 0x0400_1000); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b), 0x0400_1008); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rf_scale_table_b) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1088); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, rate_pointer_targets), 0x0400_1088); assert_eq!(PHY_RATE_POINTER_TARGET_A.get(), 0x0400_1088); assert_eq!(PHY_RATE_POINTER_TARGET_B.get(), 0x0400_1098); assert_eq!(core::mem::size_of::<OpaqueBytes<0x20>>(), 0x20); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table), 0x0400_10a8); assert_eq!(core::mem::size_of::<TxGainRssiHalfwordTable>(), 0x2c); assert_eq!(core::mem::align_of::<TxGainRssiHalfwordTable>(), 2); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, tx_gain_rssi_halfword_table) + core::mem::size_of::<TxGainRssiHalfwordTable>(), 0x0400_10d4); assert_eq!(DURATION_QUANTUM_POINTERS.get(), 0x0400_10d4); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); assert_eq!(core::mem::align_of::<InitializedVendorImage>(), 4); assert_eq!(core::mem::size_of::<DtcmLayout>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<DtcmLayout>(), 4); assert_eq!(core::mem::size_of::<SharedDtcmState>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<SharedDtcmState>(), 4); } #[test]
    ...
    fn initialized_aes_transfer_class_addresses_are_exact() {
        ...
        assert_eq!(AES_TRANSFER_CLASSES.get() + core::mem::size_of::<AesTransferClassTable>(), DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, vendor_encoded_help_text));
    }
