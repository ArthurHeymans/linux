...
struct InitializedVendorImage {
    ...
    pre_measurement_workspace: OpaqueBytes<0x14>, measurement_workspace: MeasurementWorkspace, tx_aggregate_expiration_delta: TxAggregateExpirationDelta, post_tx_aggregate_expiration_delta: OpaqueBytes<0x48>,
...
const _: () = {
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, duration_quantum_pointers) == 0x10d4); assert!(core::mem::offset_of!(InitializedVendorImage, pre_measurement_workspace) == 0x10e4); assert!(core::mem::offset_of!(InitializedVendorImage, measurement_workspace) == 0x10f8); assert!(core::mem::offset_of!(InitializedVendorImage, tx_aggregate_expiration_delta) == 0x1160); assert!(core::mem::offset_of!(InitializedVendorImage, post_tx_aggregate_expiration_delta) == 0x1164);
...
mod tests {
    ...
    #[test]
    fn tx_aggregate_expiration_delta_address_is_exact() { assert_eq!(TX_AGGREGATE_EXPIRATION_DELTA.get(), 0x0400_1160); assert_eq!(core::mem::size_of::<TxAggregateExpirationDelta>(), 0x04); assert_eq!(core::mem::align_of::<TxAggregateExpirationDelta>(), 4); assert_eq!(core::mem::offset_of!(TxAggregateExpirationDelta, value), 0); assert_eq!(TX_AGGREGATE_EXPIRATION_DELTA.get() + core::mem::size_of::<TxAggregateExpirationDelta>(), 0x0400_1164); assert_eq!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, post_tx_aggregate_expiration_delta), 0x0400_1164); assert_eq!(core::mem::size_of::<OpaqueBytes<0x48>>(), 0x48); assert_eq!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, post_tx_aggregate_expiration_delta) + core::mem::size_of::<OpaqueBytes<0x48>>(), 0x0400_11ac); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); }
    #[test]
