...
link_dtcm_data_region!(DTCM_DATA_MAC_SLOT_TIMING_PATCH_LIST, ".dtcm.data.000_mac_slot_timing_patch_list", MacSlotTimingPatchList);
link_dtcm_data_region!(DTCM_DATA_PAC_DURATION_QUANTA, ".dtcm.data.001_pac_duration_quanta", PacDurationQuanta);
link_dtcm_data_region!(DTCM_DATA_PREFIX_SUFFIX, ".dtcm.data.002_prefix_suffix", OpaqueBytes<0xc0>);
link_dtcm_data_region!(DTCM_DATA_TX_DURATION_TIMING, ".dtcm.data.003_tx_duration_timing", [SharedU16; 10]);
link_dtcm_data_region!(DTCM_DATA_PAS_RATE_STATIC_TABLES, ".dtcm.data.004_pas_rate_static_tables", PasRateStaticTables);
link_dtcm_data_region!(DTCM_DATA_RATE_ENCODING, ".dtcm.data.005_rate_encoding", [SharedU8; 22]);
link_dtcm_data_region!(DTCM_DATA_RATE_ATTRIBUTES, ".dtcm.data.006_rate_attributes", [SharedU8; 22]);
link_dtcm_data_region!(DTCM_DATA_RATE_PAIR_TABLE, ".dtcm.data.007_rate_pair_table", RatePairTable);
link_dtcm_data_region!(DTCM_DATA_INITIALIZED_RATE_POLICIES, ".dtcm.data.008_initialized_rate_policies", InitializedRatePolicies);
link_dtcm_data_region!(DTCM_DATA_COMPLETION_CALLBACK_PREFIX, ".dtcm.data.009_completion_callback_prefix", CompletionCallbackPrefix);
link_dtcm_data_region!(DTCM_DATA_VISIBLE_COMPLETION_WORDS, ".dtcm.data.010_visible_completion_words", [SharedU32; 10]);
link_dtcm_data_region!(DTCM_DATA_RING_CURSOR_MAP_TABLES, ".dtcm.data.011_ring_cursor_map_tables", RingCursorMapTables);
link_dtcm_data_region!(DTCM_DATA_QUEUE_PIPE_MAPPINGS, ".dtcm.data.012_queue_pipe_mappings", QueuePipeMappings);
link_dtcm_data_region!(DTCM_DATA_PRE_TKIP_SBOX_TABLES, ".dtcm.data.013_pre_tkip_sbox_tables", OpaqueBytes<0x2c>);
link_dtcm_data_region!(DTCM_DATA_TKIP_SBOX_TABLES, ".dtcm.data.014_tkip_sbox_tables", TkipSboxTables);
link_dtcm_data_region!(DTCM_DATA_COMMAND_DISPATCH, ".dtcm.data.015_command_dispatch", [SharedU32; 37]);
link_dtcm_data_region!(DTCM_DATA_DEBUG_CONSOLE_STRINGS, ".dtcm.data.016_debug_console_strings", DebugConsoleStrings);
link_dtcm_data_region!(DTCM_DATA_AES_TRANSFER_CLASSES, ".dtcm.data.017_aes_transfer_classes", AesTransferClassTable);
link_dtcm_data_region!(DTCM_DATA_VENDOR_ENCODED_HELP_TEXT, ".dtcm.data.018_vendor_encoded_help_text", VendorEncodedHelpText);
link_dtcm_data_region!(DTCM_DATA_VENDOR_DEBUG_ENCODED_BANNER, ".dtcm.data.019_vendor_debug_encoded_banner", VendorDebugEncodedBanner);
link_dtcm_data_region!(DTCM_DATA_EXCEPTION_REASON_NAMES, ".dtcm.data.020_exception_reason_names", ExceptionReasonNames);
link_dtcm_data_region!(DTCM_DATA_HW_TIMER_DEBUG_TABLES, ".dtcm.data.021_hw_timer_debug_tables", HwTimerDebugTables);
link_dtcm_data_region!(DTCM_DATA_PHY_GAIN_REGISTER_WRITE_LISTS, ".dtcm.data.022_phy_gain_register_write_lists", [RegisterWriteList; 2]);
link_dtcm_data_region!(DTCM_DATA_PHY_INIT_REGISTER_WRITE_LIST_0, ".dtcm.data.023_phy_init_register_write_list_0", PhyInitRegisterWriteList0);
link_dtcm_data_region!(DTCM_DATA_PHY_INIT_REGISTER_WRITE_LIST_1, ".dtcm.data.024_phy_init_register_write_list_1", PhyInitRegisterWriteList1);
link_dtcm_data_region!(DTCM_DATA_PHY_INIT_REGISTER_WRITE_LIST_2, ".dtcm.data.025_phy_init_register_write_list_2", PhyInitRegisterWriteList2);
link_dtcm_data_region!(DTCM_DATA_PHY_INIT_REGISTER_WRITE_LIST_3, ".dtcm.data.026_phy_init_register_write_list_3", PhyInitRegisterWriteList3);
link_dtcm_data_region!(DTCM_DATA_INITIALIZED_PHY_GAIN_SOURCE_RECORDS, ".dtcm.data.027_initialized_phy_gain_source_records", [InitializedPhyGainSourceRecord; 44]);
link_dtcm_data_region!(DTCM_DATA_TLV_DISPATCH_HANDLER_TABLE, ".dtcm.data.028_tlv_dispatch_handler_table", TlvDispatchHandlerTable);
link_dtcm_data_region!(DTCM_DATA_RF_MODE_HALFWORD_TABLE, ".dtcm.data.029_rf_mode_halfword_table", RfModeHalfwordTable);
link_dtcm_data_region!(DTCM_DATA_INITIALIZED_IQ_CALIBRATION_GAIN_INDICES, ".dtcm.data.030_initialized_iq_calibration_gain_indices", InitializedIqCalibrationGainIndices);
link_dtcm_data_region!(DTCM_DATA_PHY_CAL_SUBSTATE_REGISTER_WRITE_LIST, ".dtcm.data.031_phy_cal_substate_register_write_list", PhyCalSubstateRegisterWriteList);
link_dtcm_data_region!(DTCM_DATA_DBG_EXPAND_REGISTER_WRITE_LIST, ".dtcm.data.032_dbg_expand_register_write_list", DbgExpandRegisterWriteList);
link_dtcm_data_region!(DTCM_DATA_PRE_RF_SCALE_TABLES, ".dtcm.data.033_pre_rf_scale_tables", OpaqueBytes<0xc8>);
link_dtcm_data_region!(DTCM_DATA_RF_SCALE_TABLE_A, ".dtcm.data.034_rf_scale_table_a", RfScaleHalfwordTable);
link_dtcm_data_region!(DTCM_DATA_RF_SCALE_TABLE_B, ".dtcm.data.035_rf_scale_table_b", RfScaleHalfwordTable);
link_dtcm_data_region!(DTCM_DATA_RATE_POINTER_TARGETS, ".dtcm.data.036_rate_pointer_targets", OpaqueBytes<0x20>);
link_dtcm_data_region!(DTCM_DATA_TX_GAIN_RSSI_HALFWORD_TABLE, ".dtcm.data.037_tx_gain_rssi_halfword_table", TxGainRssiHalfwordTable);
link_dtcm_data_region!(DTCM_DATA_DURATION_QUANTUM_POINTERS, ".dtcm.data.038_duration_quantum_pointers", [SharedU32; 4]);
link_dtcm_data_region!(DTCM_DATA_PS_WAKE_GUARD_WORDS, ".dtcm.data.039_ps_wake_guard_words", PsWakeGuardWords);
link_dtcm_data_region!(DTCM_DATA_MEASUREMENT_WORKSPACE, ".dtcm.data.040_measurement_workspace", MeasurementWorkspace);
link_dtcm_data_region!(DTCM_DATA_TX_AGGREGATE_EXPIRATION_DELTA, ".dtcm.data.041_tx_aggregate_expiration_delta", TxAggregateExpirationDelta);
link_dtcm_data_region!(DTCM_DATA_DEBUG_COMMAND_DESCRIPTORS, ".dtcm.data.042_debug_command_descriptors", InitializedDebugCommandDescriptors);
link_dtcm_data_region!(DTCM_DATA_HIF_CONTROL, ".dtcm.data.043_hif_control", InitializedHifControl);
link_dtcm_data_region!(DTCM_DATA_IRQ_CALLBACKS, ".dtcm.data.044_irq_callbacks", [SharedU32; 32]);
link_dtcm_data_region!(DTCM_DATA_PHY_WATCHDOG_COUNTER, ".dtcm.data.045_phy_watchdog_counter", PhyWatchdogCounter);
link_dtcm_data_region!(DTCM_DATA_MULTI_VIF_BEACON_TIMER_TAIL, ".dtcm.data.046_multi_vif_beacon_timer_tail", InitializedMultiVifBeaconTimerTail);
link_dtcm_data_region!(DTCM_DATA_AMPDU_COUNTERS, ".dtcm.data.047_ampdu_counters", AmpduTelemetryCounters);
link_dtcm_data_region!(DTCM_DATA_RETRY_PATH_COUNTER, ".dtcm.data.048_retry_path_counter", RetryPathCounter);
link_dtcm_data_region!(DTCM_DATA_PER_TID_TELEMETRY_BANK, ".dtcm.data.049_per_tid_telemetry_bank", PerTidTelemetryBank);
link_dtcm_data_region!(DTCM_DATA_AMPDU_COMPLETION_CONTROL, ".dtcm.data.050_ampdu_completion_control", AmpduCompletionControl);
link_dtcm_data_region!(DTCM_DATA_TX_CONFIRM_AGGREGATION_STATE, ".dtcm.data.051_tx_confirm_aggregation_state", TxConfirmAggregationState);
link_dtcm_data_region!(DTCM_DATA_CONFIGURATION_APPLY_FLAGS, ".dtcm.data.052_configuration_apply_flags", ConfigurationApplyFlags);
link_dtcm_data_region!(DTCM_DATA_CONTROL_WORDS, ".dtcm.data.053_control_words", InitializedControlWords);
link_dtcm_data_region!(DTCM_DATA_PRE_PHY_CHANNEL_THRESHOLD_DESCRIPTORS, ".dtcm.data.054_pre_phy_channel_threshold_descriptors", OpaqueBytes<0x14>);
link_dtcm_data_region!(DTCM_DATA_DEBUG_PLATFORM_LOCAL_TAIL, ".dtcm.data.055_debug_platform_local_tail", DebugPlatformLocalTail);
link_dtcm_data_region!(DTCM_DATA_PHY_CHANNEL_THRESHOLD_DESCRIPTORS, ".dtcm.data.056_phy_channel_threshold_descriptors", [PhyChannelThresholdDescriptor; 2]);
link_dtcm_data_region!(DTCM_DATA_PHY_GAIN_PROGRAMMING_RECORDS, ".dtcm.data.057_phy_gain_programming_records", [PhyGainProgrammingRecord; 16]);
link_dtcm_data_region!(DTCM_DATA_PRE_HOST_PAS_RING, ".dtcm.data.058_pre_host_pas_ring", PreHostPasRingObserved);
link_dtcm_data_region!(DTCM_DATA_HOST_PAS_RING, ".dtcm.data.059_host_pas_ring", HostPasRing);
link_dtcm_data_region!(DTCM_DATA_INITIALIZED_LOW_MAC_PREFIX, ".dtcm.data.060_initialized_low_mac_prefix", LowMacGlobalPrefix);
link_dtcm_data_region!(DTCM_DATA_MAC_PIPE_RECORDS, ".dtcm.data.061_mac_pipe_records", [MacPipeRecord; 4]);
link_dtcm_data_region!(DTCM_DATA_MAC_TX_QUEUE_STATE, ".dtcm.data.062_mac_tx_queue_state", MacTxQueueState);
link_dtcm_data_region!(DTCM_DATA_PRE_MAC_BEACON_STATE, ".dtcm.data.063_pre_mac_beacon_state", OpaqueBytes<0x1a8>);
link_dtcm_data_region!(DTCM_DATA_MAC_BEACON_STATE, ".dtcm.data.064_mac_beacon_state", MacBeaconState);
link_dtcm_data_region!(DTCM_DATA_MAC_WAKE_RUNTIME_STATE, ".dtcm.data.065_mac_wake_runtime_state", MacWakeRuntimeState);
link_dtcm_data_region!(DTCM_DATA_PRE_MAC_PHY_COMMAND_STATE, ".dtcm.data.066_pre_mac_phy_command_state", OpaqueBytes<0x08>);
link_dtcm_data_region!(DTCM_DATA_MAC_AGGREGATE_SLOT_TABLES, ".dtcm.data.067_mac_aggregate_slot_tables", MacAggregateSlotTables);
link_dtcm_data_region!(DTCM_DATA_MAC_PHY_COMMAND_STATE, ".dtcm.data.068_mac_phy_command_state", MacPhyCommandState);
link_dtcm_data_region!(DTCM_DATA_MAC_PIPE_TAILS, ".dtcm.data.069_mac_pipe_tails", MacPipeTails);
link_dtcm_data_region!(DTCM_DATA_MAC_RETRY_HARDWARE_STATE, ".dtcm.data.070_mac_retry_hardware_state", MacRetryHardwareState);
link_dtcm_data_region!(DTCM_DATA_PRE_MAC_RUNTIME_ACCOUNTING, ".dtcm.data.071_pre_mac_runtime_accounting", OpaqueBytes<0x108>);
link_dtcm_data_region!(DTCM_DATA_MAC_RUNTIME_ACCOUNTING, ".dtcm.data.072_mac_runtime_accounting", MacRuntimeAccountingState);
link_dtcm_data_region!(DTCM_DATA_SCHEDULER_EXCLUSION_STATE, ".dtcm.data.073_scheduler_exclusion_state", SchedulerExclusionState);
link_dtcm_data_region!(DTCM_DATA_SCHEDULER_EVENT_ISLAND, ".dtcm.data.074_scheduler_event_island", SchedulerEventIsland);
link_dtcm_data_region!(DTCM_DATA_INITIALIZED_TAIL, ".dtcm.data.075_initialized_tail", SchedulerTail);
