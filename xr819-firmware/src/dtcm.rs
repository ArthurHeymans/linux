...
struct InitializedVendorImage {
    ...
    phy_watchdog_counter: PhyWatchdogCounter, pre_ampdu_counters_tail: OpaqueBytes<0x60>,
...
pub(crate) const IRQ_CALLBACK_TABLE: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, irq_callbacks)); pub(crate) const PHY_WATCHDOG_COUNTER: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, phy_watchdog_counter) + core::mem::offset_of!(PhyWatchdogCounter, count));
...
const _: () = {
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, irq_callbacks) == 0x11bc); assert_type_layout!(PhyWatchdogCounter, 0x04, 4); assert!(core::mem::offset_of!(PhyWatchdogCounter, count) == 0); assert!(core::mem::offset_of!(InitializedVendorImage, phy_watchdog_counter) == 0x123c); assert!(core::mem::offset_of!(InitializedVendorImage, pre_ampdu_counters_tail) == 0x1240); assert!(core::mem::offset_of!(InitializedVendorImage, ampdu_counters) == 0x12a0); assert_type_layout!(InitializedVendorImage, 0x2078, 4); assert_type_layout!(DtcmLayout, DTCM_STATE_SIZE, 4); assert_type_layout!(SharedDtcmState, DTCM_STATE_SIZE, 4);
...
mod tests {
    ...
    #[test]
    fn initialized_phy_watchdog_counter_address_is_exact() { assert_eq!(core::mem::size_of::<PhyWatchdogCounter>(), 0x04); assert_eq!(core::mem::align_of::<PhyWatchdogCounter>(), 4); assert_eq!(core::mem::offset_of!(PhyWatchdogCounter, count), 0); assert_eq!(IRQ_CALLBACK_TABLE.get() + core::mem::size_of::<[SharedU32; 32]>(), 0x0400_123c); assert_eq!(PHY_WATCHDOG_COUNTER.get(), 0x0400_123c); assert_eq!(PHY_WATCHDOG_COUNTER.get() + core::mem::size_of::<PhyWatchdogCounter>(), 0x0400_1240); assert_eq!(core::mem::offset_of!(InitializedVendorImage, pre_ampdu_counters_tail), 0x1240); assert_eq!(core::mem::size_of::<OpaqueBytes<0x60>>(), 0x60); assert_eq!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, pre_ampdu_counters_tail) + core::mem::size_of::<OpaqueBytes<0x60>>(), 0x0400_12a0); assert_eq!(AMPDU_TELEMETRY_COUNTERS.get(), 0x0400_12a0); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); assert_eq!(core::mem::align_of::<InitializedVendorImage>(), 4); assert_eq!(core::mem::size_of::<DtcmLayout>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<DtcmLayout>(), 4); assert_eq!(core::mem::size_of::<SharedDtcmState>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<SharedDtcmState>(), 4); }
