...
struct InitializedVendorImage {
    ...
    phy_init_register_write_list_0: PhyInitRegisterWriteList0, phy_init_register_write_list_1: PhyInitRegisterWriteList1, phy_init_register_write_list_2: PhyInitRegisterWriteList2, post_phy_init_register_write_lists_prefix: OpaqueBytes<0x46>, initialized_phy_gain_source_records: [InitializedPhyGainSourceRecord; 43], post_initialized_phy_gain_source_records: OpaqueBytes<0x70>, initialized_iq_calibration_gain_indices: InitializedIqCalibrationGainIndices, /* Retained rf_write_iq_corr_regs performs an unchecked u32 lookahead at suffix start 0x04000e48; the same address is a distinct phy_cal_apply_substate register-list root and remains opaque. */ post_initialized_iq_calibration_gain_indices: OpaqueBytes<0x28c>,
    ...
    tx_confirm_aggregation_state: TxConfirmAggregationState, pre_control_words: OpaqueBytes<0x04>,
...
pub const INITIALIZED_VENDOR_IMAGE: DtcmAddress = DtcmAddress::from_offset(0x0000); pub const TKIP_SBOX_TABLES: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, tkip_sbox_tables)); pub(crate) const AES_TRANSFER_CLASSES: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, aes_transfer_classes)); pub(crate) const PHY_GAIN_REGISTER_WRITE_LISTS: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, phy_gain_register_write_lists)); pub(crate) const PHY_INIT_REGISTER_WRITE_LISTS: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, phy_init_register_write_list_0)); pub(crate) const INITIALIZED_PHY_GAIN_SOURCE_RECORDS: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, initialized_phy_gain_source_records)); pub(crate) const INITIALIZED_IQ_CALIBRATION_GAIN_INDICES: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedVendorImage, initialized_iq_calibration_gain_indices));
...
mod tests {
    ...
    #[test]
    fn initialized_iq_calibration_gain_index_addresses_are_exact() { assert_eq!(core::mem::size_of::<InitializedIqCalibrationGainIndices>(), 0x30); assert_eq!(core::mem::align_of::<InitializedIqCalibrationGainIndices>(), 4); assert_eq!(core::mem::offset_of!(InitializedIqCalibrationGainIndices, entries), 0); assert_eq!(core::mem::offset_of!(InitializedVendorImage, post_initialized_phy_gain_source_records), 0x0da8); assert_eq!(core::mem::size_of::<OpaqueBytes<0x70>>(), 0x70); assert_eq!(INITIALIZED_IQ_CALIBRATION_GAIN_INDICES.get(), 0x0400_0e18); assert_eq!(initialized_iq_calibration_gain_index(0).unwrap().get(), 0x0400_0e18); assert_eq!(initialized_iq_calibration_gain_index(1).unwrap().get(), 0x0400_0e1c); assert_eq!(initialized_iq_calibration_gain_index(11).unwrap().get(), 0x0400_0e44); assert!(initialized_iq_calibration_gain_index(12).is_none()); assert_eq!(INITIALIZED_IQ_CALIBRATION_GAIN_INDICES.get() + core::mem::size_of::<InitializedIqCalibrationGainIndices>(), 0x0400_0e48); assert_eq!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, post_initialized_iq_calibration_gain_indices), 0x0400_0e48); assert_eq!(core::mem::size_of::<OpaqueBytes<0x28c>>(), 0x28c); assert_eq!(DURATION_QUANTUM_POINTERS.get(), 0x0400_10d4); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); }
    #[test]
    ...
    #[test]
    fn initialized_tx_confirm_aggregation_state_addresses_are_exact() { let image = DTCM_STATE_BASE; let record = image + core::mem::offset_of!(InitializedVendorImage, tx_confirm_aggregation_state); let fields = [record + core::mem::offset_of!(TxConfirmAggregationState, state), record + core::mem::offset_of!(TxConfirmAggregationState, pending_message_raw), record + core::mem::offset_of!(TxConfirmAggregationState, append_cursor_raw)]; assert_eq!(core::mem::size_of::<SharedU32>(), 4); assert_eq!(core::mem::align_of::<SharedU32>(), 4); assert_eq!(core::mem::size_of::<TxConfirmAggregationState>(), 0x0c); assert_eq!(core::mem::align_of::<TxConfirmAggregationState>(), 4); assert_eq!([core::mem::offset_of!(TxConfirmAggregationState, state), core::mem::offset_of!(TxConfirmAggregationState, pending_message_raw), core::mem::offset_of!(TxConfirmAggregationState, append_cursor_raw)], [0x00, 0x04, 0x08]); assert_eq!(fields, [0x0400_1410, 0x0400_1414, 0x0400_1418]); for pair in fields.windows(2) { assert_eq!(pair[0] + core::mem::size_of::<SharedU32>(), pair[1]); } assert_eq!(record, 0x0400_1410); assert_eq!(record + core::mem::size_of::<TxConfirmAggregationState>(), 0x0400_141c); assert_eq!(AMPDU_COMPLETION_CONTROL.get(), 0x0400_140c); assert_eq!(AMPDU_COMPLETION_CONTROL.get() + core::mem::size_of::<AmpduCompletionControl>(), 0x0400_1410); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, pre_control_words), 0x0400_141c); assert_eq!(core::mem::size_of::<OpaqueBytes<0x04>>(), 4); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, pre_control_words) + core::mem::size_of::<OpaqueBytes<0x04>>(), 0x0400_1420); assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, control_words), 0x0400_1420); assert_eq!(core::mem::size_of::<InitializedVendorImage>(), 0x2078); assert_eq!(core::mem::align_of::<InitializedVendorImage>(), 4); assert_eq!(core::mem::size_of::<DtcmLayout>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<DtcmLayout>(), 4); assert_eq!(core::mem::size_of::<SharedDtcmState>(), DTCM_STATE_SIZE); assert_eq!(core::mem::align_of::<SharedDtcmState>(), 4); }
