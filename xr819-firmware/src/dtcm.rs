...
struct InitializedVendorImage {
    ...
    pre_measurement_workspace: OpaqueBytes<0x14>, measurement_workspace: MeasurementWorkspace, post_measurement_workspace: OpaqueBytes<0x4c>,
...
const _: () = {
    ...
    assert!(core::mem::offset_of!(InitializedVendorImage, duration_quantum_pointers) == 0x10d4); assert!(core::mem::offset_of!(InitializedVendorImage, pre_measurement_workspace) == 0x10e4); assert!(core::mem::offset_of!(InitializedVendorImage, measurement_workspace) == 0x10f8); assert!(core::mem::offset_of!(InitializedVendorImage, post_measurement_workspace) == 0x1160);
