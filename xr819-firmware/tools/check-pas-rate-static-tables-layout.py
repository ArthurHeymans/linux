...
REQUIRED = (
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, pas_rate_static_tables) + core::mem::size_of::<PasRateStaticTables>() == 0x0400_0194);",
    "offset_of!(InitializedDtcmPrefix, rate_encoding) == 0x0194",
    "offset_of!(InitializedDtcmPrefix, rate_attributes) == 0x01aa",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    'assert!(core::mem::offset_of!(InitializedDtcmPrefix, pas_rate_static_tables) == 0x014c);',
    'assert_type_layout!(PasRateStaticTables, 0x48, 4);',
    'assert!(core::mem::offset_of!(PasRateStaticTables, mcs_fallback_rates) == 0x00);',
    'assert!(core::mem::offset_of!(PasRateStaticTables, pas_fallback_suffix) == 0x08);',
    'assert!(core::mem::size_of::<OpaqueBytes<0x8>>() == 0x8);',
