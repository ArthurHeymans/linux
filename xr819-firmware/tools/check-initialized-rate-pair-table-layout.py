...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, rate_pair_table) == 0x01c0",
    "offset_of!(InitializedDtcmPrefix, initialized_rate_policies) == 0x0200",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, rate_pair_table) == 0x0400_01c0);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, rate_pair_table) + core::mem::size_of::<RatePairTable>() == 0x0400_0200);",
)
FOCUSED_TEST_INVENTORY = (
    "let image = DTCM_STATE_BASE;",
    "let table = image + core::mem::offset_of!(InitializedDtcmPrefix, rate_pair_table);",
