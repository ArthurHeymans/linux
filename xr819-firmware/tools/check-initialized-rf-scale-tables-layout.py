...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, pre_rf_scale_tables) == 0x0ec0",
    "size_of::<OpaqueBytes<0xc8>>() == 0xc8",
    "offset_of!(InitializedDtcmPrefix, rf_scale_table_a) == 0x0f88",
    "offset_of!(InitializedDtcmPrefix, rf_scale_table_b) == 0x1008",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, pre_rf_scale_tables) == 0x0ec0);",
    "assert!(core::mem::size_of::<OpaqueBytes<0xc8>>() == 0xc8);",
    "assert_type_layout!(RfScaleHalfwordTable, 0x80, 2);",
    "assert!(core::mem::offset_of!(RfScaleHalfwordTable, entries) == 0);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_a) == 0x0f88);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_a) + core::mem::size_of::<RfScaleHalfwordTable>() == 0x0400_1008);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_b) == 0x1008);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_b) + core::mem::size_of::<RfScaleHalfwordTable>() == 0x0400_1088);",
...
FOCUSED_TEST_INVENTORY = (
    ...
    'let cal = image + core::mem::offset_of!(InitializedDtcmPrefix, phy_cal_substate_register_write_list);',
    'let dbg = image + core::mem::offset_of!(InitializedDtcmPrefix, dbg_expand_register_write_list);',
    ...
    'assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, pre_rf_scale_tables), 0x0400_0ec0);',
    ...
    'assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_a), 0x0400_0f88);',
    'assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_a) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1008);',
    'assert_eq!(RF_SCALE_TABLE_A_MODE0_TARGET.get(), 0x0400_1000);',
    'assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_b), 0x0400_1008);',
    'assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, rf_scale_table_b) + core::mem::size_of::<RfScaleHalfwordTable>(), 0x0400_1088);',
