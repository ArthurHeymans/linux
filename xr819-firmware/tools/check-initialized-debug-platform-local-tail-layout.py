...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, pre_phy_channel_threshold_descriptors) == 0x1440",
    "offset_of!(InitializedDtcmPrefix, debug_platform_local_tail) == 0x1454",
    "offset_of!(InitializedDtcmPrefix, phy_channel_threshold_descriptors) == 0x145c",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, pre_phy_channel_threshold_descriptors) == 0x1440);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, debug_platform_local_tail) == 0x1454);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, debug_platform_local_tail) + core::mem::offset_of!(DebugPlatformLocalTail, platform_local_word_2c) == 0x0400_1454);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, debug_platform_local_tail) + core::mem::offset_of!(DebugPlatformLocalTail, platform_local_word_30) == 0x0400_1458);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, debug_platform_local_tail) + core::mem::size_of::<DebugPlatformLocalTail>() == 0x0400_145c);",
...
FOCUSED_TEST_INVENTORY = (
    ...
    "let opaque = image + core::mem::offset_of!(InitializedDtcmPrefix, pre_phy_channel_threshold_descriptors);",
    "let tail = image + core::mem::offset_of!(InitializedDtcmPrefix, debug_platform_local_tail);",
    ...
    "let phy = image + core::mem::offset_of!(InitializedDtcmPrefix, phy_channel_threshold_descriptors);",
