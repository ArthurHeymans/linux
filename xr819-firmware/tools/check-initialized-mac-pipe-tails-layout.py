...
ALLOWED_DECODED_XREFS: collections.Counter[tuple[str, int]] = collections.Counter({
    ("_RNvNtCs2QKOjPfuf9x_14xr819_firmware3mac23reinitialize_after_wake", 0x04001D9C): 1,
})
STRUCT = (
...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, mac_pipe_tails) == 0x1d5c",
    "offset_of!(InitializedDtcmPrefix, mac_retry_hardware_state) == 0x1e6c",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, mac_pipe_tails) == 0x1d5c);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, mac_pipe_tails) + core::mem::size_of::<MacPipeTails>() == 0x0400_1e6c);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, mac_retry_hardware_state) == 0x1e6c);",
)
FOCUSED_TEST_INVENTORY = (
    "let image = DTCM_STATE_BASE;",
    "let tails = image + core::mem::offset_of!(InitializedDtcmPrefix, mac_pipe_tails);",
