...
REQUIRED = (
    ...
    "pub(crate) const MEASUREMENT_DWELL_TIMER: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedDtcmPrefix, multi_vif_beacon_timer_tail) + core::mem::offset_of!(InitializedMultiVifBeaconTimerTail, measurement_dwell_timer));",
    ...
    "offset_of!(InitializedDtcmPrefix, multi_vif_beacon_timer_tail) == 0x1240",
    "offset_of!(InitializedDtcmPrefix, ampdu_counters) == 0x12a0",
    ...
    "let tail = DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, multi_vif_beacon_timer_tail)",
