...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, pre_mac_phy_command_state) == 0x1b08",
    "offset_of!(InitializedDtcmPrefix, mac_aggregate_slot_tables) == 0x0400_1b10",
    "offset_of!(InitializedDtcmPrefix, mac_phy_command_state) == 0x1d10",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, pre_mac_phy_command_state) == 0x1b08);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, pre_mac_phy_command_state) + core::mem::size_of::<OpaqueBytes<0x08>>() == 0x0400_1b10);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, mac_aggregate_slot_tables) == 0x0400_1b10);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, mac_aggregate_slot_tables) + core::mem::size_of::<MacAggregateSlotTables>() == 0x0400_1d10);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, mac_phy_command_state) == 0x1d10);",
)
FOCUSED_TEST_INVENTORY = (
    "let image = DTCM_STATE_BASE;",
    "let prefix = image + core::mem::offset_of!(InitializedDtcmPrefix, pre_mac_phy_command_state);",
    "let tables = image + core::mem::offset_of!(InitializedDtcmPrefix, mac_aggregate_slot_tables);",
