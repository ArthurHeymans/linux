...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, mac_slot_timing_patch_list) == 0x0000",
    "offset_of!(InitializedDtcmPrefix, pac_duration_quanta) == 0x0058",
    "offset_of!(InitializedDtcmPrefix, prefix_suffix) == 0x0078",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, mac_slot_timing_patch_list) == 0x0000);",
    "assert_type_layout!(MacSlotTimingPatchEntry, 0x08, 4);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, mac_slot_timing_patch_list) + core::mem::size_of::<MacSlotTimingPatchList>() == 0x0400_0058);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, pac_duration_quanta) == 0x0058);",
    "assert_type_layout!(PacDurationQuanta, 0x20, 4);",
    "assert!(core::mem::offset_of!(PacDurationQuanta, quanta) == 0);",
    "assert!(core::mem::size_of::<[SharedU32; 8]>() == 0x20);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, pac_duration_quanta) + core::mem::size_of::<PacDurationQuanta>() == 0x0400_0078);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, prefix_suffix) == 0x0078);",
    "assert!(core::mem::size_of::<OpaqueBytes<0xc0>>() == 0xc0);",
)
FOCUSED_TEST_INVENTORY = (
    'let image = DTCM_STATE_BASE;',
    'let list = image + core::mem::offset_of!(InitializedDtcmPrefix, mac_slot_timing_patch_list);',
    'let quanta = image + core::mem::offset_of!(InitializedDtcmPrefix, pac_duration_quanta);',
    'let suffix = image + core::mem::offset_of!(InitializedDtcmPrefix, prefix_suffix);',
    ...
    'let pas_tables = image + core::mem::offset_of!(InitializedDtcmPrefix, pas_rate_static_tables);',
    ...
    'let ccb = image + core::mem::offset_of!(InitializedDtcmPrefix, completion_callback_prefix);',
    ...
    'let rcm = image + core::mem::offset_of!(InitializedDtcmPrefix, ring_cursor_map_tables);',
