...
REQUIRED = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, completion_callback_prefix) == 0x0228);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, completion_callback_prefix) + core::mem::size_of::<CompletionCallbackPrefix>() == 0x0400_0260);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, ring_cursor_map_tables) == 0x0288);",
    ...
    "assert!(core::mem::size_of::<OpaqueBytes<0x30>>() == 0x30);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, ring_cursor_map_tables) + core::mem::size_of::<RingCursorMapTables>() == 0x0400_02d8);",
    "offset_of!(InitializedDtcmPrefix, visible_completion_words) == 0x0260",
    "offset_of!(InitializedDtcmPrefix, queue_pipe_mappings) == 0x02d8",
