...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, phy_cal_substate_register_write_list) == 0x0e48",
    "offset_of!(InitializedDtcmPrefix, dbg_expand_register_write_list) == 0x0e90",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, phy_cal_substate_register_write_list) == 0x0e48);",
    "assert_type_layout!(PhyCalSubstateRegisterWriteList, 0x48, 4);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, phy_cal_substate_register_write_list) + core::mem::size_of::<PhyCalSubstateRegisterWriteList>() == 0x0400_0e90);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, dbg_expand_register_write_list) == 0x0e90);",
    "assert_type_layout!(DbgExpandRegisterWriteList, 0x30, 4);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, dbg_expand_register_write_list) + core::mem::size_of::<DbgExpandRegisterWriteList>() == 0x0400_0ec0);",
...
def family_aliases(code: str) -> tuple[set[str], list[tuple[str, str, str]]]:
    ...
    views = {"RegisterWriteListsView", "register_write_lists",
...
def check_source() -> None:
    ...
    if re.search(r"\bimpl(?:\s*<[^>]*>)?\s+[^\{]*RegisterWriteListsView", production):
