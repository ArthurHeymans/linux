...
REQUIRED = (
    ...
    "pub(crate) const PHY_WATCHDOG_COUNTER: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedDtcmPrefix, phy_watchdog_counter) + core::mem::offset_of!(PhyWatchdogCounter, count));",
    "assert_type_layout!(PhyWatchdogCounter, 0x04, 4)",
    "offset_of!(PhyWatchdogCounter, count) == 0",
    "offset_of!(InitializedDtcmPrefix, phy_watchdog_counter) == 0x123c",
