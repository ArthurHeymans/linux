...
REQUIRED = (
    STRUCT,
    "post_initialized_phy_gain_source_records: OpaqueBytes<0x28>, rf_mode_halfword_table: RfModeHalfwordTable,",
    ...
    "offset_of!(InitializedVendorImage, post_initialized_phy_gain_source_records) == 0x0da8",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) == 0x0dd0);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) == 0x0400_0dd0);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table) + core::mem::size_of::<RfModeHalfwordTable>() == 0x0400_0e18);",
...
FOCUSED_TEST_INVENTORY = (
    ...
    "let table = image + core::mem::offset_of!(InitializedVendorImage, rf_mode_halfword_table);",
    "let opaque = image + core::mem::offset_of!(InitializedVendorImage, post_initialized_phy_gain_source_records);",
    "assert_eq!(opaque, 0x0400_0da8);",
    "assert_eq!(core::mem::size_of::<OpaqueBytes<0x28>>(), 0x28);",
...
def check_exact_inventory_regression(source: str) -> None:
    ...
    test_address_swap = normalized(test_scope).replace(
        test_address_item,
        swapped_once(test_address_item, "0x0400_0dd0", "0x0400_0da8"),
        1,
    )
    test_extent_item = normalized(FOCUSED_TEST_INVENTORY[10])
...
def family_aliases(code: str) -> tuple[set[str], list[tuple[str, str, str]]]:
    ...
    views = {"MacPipeTail", "RfModeHalfwordTable", "rf_mode_halfword_table",
