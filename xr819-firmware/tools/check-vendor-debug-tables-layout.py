...
REQUIRED = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, vendor_debug_encoded_banner) == 0x09de);",
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, exception_reason_names) == 0x0b28);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, exception_reason_names) == 0x0400_0b28);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, hw_timer_debug_tables) == 0x0b3c);",
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, hw_timer_debug_tables) + core::mem::size_of::<HwTimerDebugTables>() == 0x0400_0b60);",
    "offset_of!(InitializedDtcmPrefix, phy_gain_register_write_lists) == 0x0b60",
