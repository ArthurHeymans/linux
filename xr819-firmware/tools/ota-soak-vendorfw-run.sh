...
recover() {
  ...
  $SSH 'cd /lib/firmware/xr819; cp boot_xr819.bin.ours boot_xr819.bin; cp /root/xr819-vendor-host-tx-event-drain.bin fw_xr819.bin; sync; systemctl reboot' 2>/dev/null || true
}
...
$SSH "set -e; cd /lib/firmware/xr819; cp -n boot_xr819.bin boot_xr819.bin.ours; cp boot_xr819.bin.vendor boot_xr819.bin; cp fw_xr819.bin.vendor fw_xr819.bin; sync; sha256sum boot_xr819.bin fw_xr819.bin; systemctl reboot" 2>/dev/null || true
