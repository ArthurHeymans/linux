...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) == 0x1410",
    "offset_of!(InitializedDtcmPrefix, configuration_apply_flags) == 0x141c",
    "offset_of!(InitializedDtcmPrefix, control_words) == 0x1420",
    ...
    "offset_of!(InitializedDtcmPrefix, configuration_apply_flags), 0x0400_141c",
    "offset_of!(InitializedDtcmPrefix, control_words), 0x0400_1420",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) == 0x1410);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::offset_of!(TxConfirmAggregationState, state) == 0x0400_1410);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::offset_of!(TxConfirmAggregationState, pending_message_raw) == 0x0400_1414);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::offset_of!(TxConfirmAggregationState, append_cursor_raw) == 0x0400_1418);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::size_of::<TxConfirmAggregationState>() == 0x0400_141c);",
    "assert_type_layout!(ConfigurationApplyFlags, 0x04, 4);",
    "assert!(core::mem::offset_of!(ConfigurationApplyFlags, flags) == 0x00);",
    "assert!(core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags) == 0x141c);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags) == 0x0400_141c);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags) + core::mem::offset_of!(ConfigurationApplyFlags, flags) == 0x0400_141c);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags) + core::mem::size_of::<ConfigurationApplyFlags>() == 0x0400_1420);", 
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, control_words) == 0x0400_1420);",
    "assert_type_layout!(InitializedDtcmPrefix, 0x2078, 4);",
    "assert_type_layout!(DtcmLayout, DTCM_STATE_SIZE, 4);",
    "assert_type_layout!(SharedDtcmState, DTCM_STATE_SIZE, 4);",
)
FOCUSED_TEST_INVENTORY = (
    ...
    "let record = image + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state);",
    ...
    "assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags), 0x0400_141c);",
    "assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, control_words), 0x0400_1420);",
