...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, initialized_tail) == 0x2018",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedDtcmPrefix, initialized_tail) + core::mem::offset_of!(SchedulerTail, opaque_204c) == 0x0400_204c);",
...
FOCUSED_TEST_INVENTORY = (
    ...
    "let tail = image + core::mem::offset_of!(InitializedDtcmPrefix, initialized_tail);",
...
def family_aliases(code: str) -> tuple[set[str], list[tuple[str, str, str]]]:
    ...
    views = {"SchedulerTail", "scheduler_tail",
...
def check_source() -> None:
    ...
    if re.search(r"\bimpl(?:\s*<[^>]*>)?\s+[^\{]*SchedulerTail", production):
