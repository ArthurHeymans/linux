...
REQUIRED_INVENTORY = (
    ...
    "pub(crate) const TX_AGGREGATE_EXPIRATION_DELTA: DtcmAddress = DtcmAddress::from_offset(core::mem::offset_of!(InitializedDtcmPrefix, tx_aggregate_expiration_delta));",
