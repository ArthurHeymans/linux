...
REQUIRED = (
    ...
    "offset_of!(InitializedVendorImage, per_tid_telemetry_bank), 0x0400_12cc",
...
COMPILE_TIME_PHYSICAL_INVENTORY = (
    ...
    "assert!(core::mem::offset_of!(InitializedVendorImage, retry_path_counter) == 0x12c8);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, retry_path_counter) + core::mem::offset_of!(RetryPathCounter, count) == 0x0400_12c8);",
    "assert!(DTCM_STATE_BASE + core::mem::offset_of!(InitializedVendorImage, retry_path_counter) + core::mem::size_of::<RetryPathCounter>() == 0x0400_12cc);",
    "assert!(core::mem::offset_of!(InitializedVendorImage, per_tid_telemetry_bank) == 0x12cc);",
)
FOCUSED_TEST_INVENTORY = (
    "let image = DTCM_STATE_BASE;",
    "let record = image + core::mem::offset_of!(InitializedVendorImage, retry_path_counter);",
    ...
    "assert_eq!(image + core::mem::offset_of!(InitializedVendorImage, per_tid_telemetry_bank), 0x0400_12cc);",
