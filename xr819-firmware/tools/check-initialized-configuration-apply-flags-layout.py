...
REQUIRED = (
    ...
    "offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::size_of::<TxConfirmAggregationState>() == 0x0400_141c",
...
FOCUSED_TEST_INVENTORY = (
    ...
    "let record = image + core::mem::offset_of!(InitializedDtcmPrefix, configuration_apply_flags);",
    ...
    "assert_eq!(image + core::mem::offset_of!(InitializedDtcmPrefix, tx_confirm_aggregation_state) + core::mem::size_of::<TxConfirmAggregationState>(), 0x0400_141c);",
